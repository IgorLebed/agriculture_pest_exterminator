...
diagnostic_publisher = rospy.Publisher("/diagnostics", DiagnosticStatus, queue_size = 1)
batcon = serial.Serial("/dev/ttyUSB0", 57600, 8, 'N', 1, timeout=1)
...
while not rospy.is_shutdown():
	...
	rospy.loginfo(batvalue)
	valuevoltage.value = str(batvalue)
